...
echo "python3 pi-aircraft-detector.py --web --web-port 8081 --enable-adsb --adsb-json-dir /run/dump1090-mutability --camera-lat $LATITUDE --camera-lon $LONGITUDE --save-detections"
echo ""
